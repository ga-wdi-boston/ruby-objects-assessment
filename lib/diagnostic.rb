...
##
Housecat is a class that inherits from Animal and Cat.  Because it is its own class,
"Housecat" will display for "#{self.class.name}".  Within the HouseCat class, @sound has hte value 'meow',
so that is the sound that will be included in the output.
##
...
##
Mixins allow you to make chunks of code that are reusable across multiple classes.  This allow developers to keep their code DRY.
##
