...
Response.housecat_noise = "I am HouseCat and I go 'meow'"

## Explain why this would be the output, based on the method lookup chain.
"HouseCat inherits from Cat which inherites from Animal, so it would print the Animals with with the HouseCAt initiatlized value and it will reference the HouseCat class name when it uses self.class.name "
##
...
class ComboAttack
  ...
  def damage
    puts "Here it is you damage #{@damage}"
  end
 ...
 puts ComboAttack.new.punch.move('left').kick.damage
