...
#  The grandparent class Animal has the method say_hello. Descendent classes
# will inherit the attributes and methods of the antecedent classes unless
#  they override them. Since HouseCat is a grandchild of Animal, the HouseCat
# class inherits the say_hello method.
##
...
##
# Semantically unrelated classes that share the same semantic behavior trait can
