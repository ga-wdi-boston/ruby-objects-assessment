...
# The first interpolation would translate over to HouseCat and
# the last interpolation would translate over to meow.
##
...
##
# You can include multiple mixins whereas you can only inherit from one class
##
