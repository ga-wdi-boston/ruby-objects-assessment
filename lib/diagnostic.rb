...
The class HouseCat inherits the say_hello method from the Cat class, which
inherited it from the Animal class, but the HouseCat has "it's" own initialize
method so it will say 'meow'.
##
