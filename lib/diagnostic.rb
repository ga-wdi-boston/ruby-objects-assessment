...
# It looks for a say_hello method in the HouseCat class, but doesn't find it;
# then it goes to the Cat class, still doesn't find it; and then it goes to the
# Animal class, where it finds the say_hello method. However, 'self' is
# still referring to the HouseCat.
...
##
# Using composition allows developers to change the behavior of classes flexibly
# and dynamically without having to change the way they were instantiated.
##
