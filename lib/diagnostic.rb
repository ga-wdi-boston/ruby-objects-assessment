...
##
# Self.class.name refers to the class name of whatever is calling it.
##
...
##
# It allows for use of pieces of code that may be useful to other classes but
# unrelated to the class itself
##
