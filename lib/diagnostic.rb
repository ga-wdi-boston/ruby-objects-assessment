...
# The HouseCat is inherits from the Cat,  and the Cat inherits from the Animal. The method, say_hello, is
# not defined in HouseCat, then ruby will look up the supper class Cat. There is no
# say_hello method in Cat, then, ruby continuely looks up its supper class get the method.
# The method is called by class HouseCat, therefore, the class.name is 'HouseCat'.
##
...
##
# Mixins stores methods, is opening to all the classes.
##
