...
##
 # @sound is initalized in the Animal class, which HouseCat inherits from, but is
 # overwritten in the instantiation of an instance of HouseCat. say_hello is an instance
 # method inherited from Animal by HouseCat
...
##
# Ruby is single inheritance, so if we want to include behaviors from multiple
# different places, it is best to use mixins
##
